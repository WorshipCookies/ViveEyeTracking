...
namespace Valve.VR
{
    ...
    public partial class SteamVR_Actions
    {
        ...
        private static SteamVR_Input_ActionSet_StandardControl p_StandardControl;
        ...
        public static SteamVR_Input_ActionSet_StandardControl StandardControl
        {
            get
            {
                return SteamVR_Actions.p_StandardControl.GetCopy<SteamVR_Input_ActionSet_StandardControl>();
            }
        }
        ...
        private static void StartPreInitActionSets()
        {
            ...
            SteamVR_Actions.p_StandardControl = ((SteamVR_Input_ActionSet_StandardControl)(SteamVR_ActionSet.Create<SteamVR_Input_ActionSet_StandardControl>("/actions/StandardControl")));
            Valve.VR.SteamVR_Input.actionSets = new Valve.VR.SteamVR_ActionSet[] {
                    SteamVR_Actions._default,
                    SteamVR_Actions.platformer,
                    SteamVR_Actions.buggy,
                    SteamVR_Actions.mixedreality,
                    SteamVR_Actions.StandardControl};
        }
    }
}
